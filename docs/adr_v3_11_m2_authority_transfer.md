...
### 6. Rollback drill (completed)

Gate M2-04 evidence: `release/evidence/keep_path_rc/2026-04-09/m2_rollback_drill_report.json`  
Result: `drill_passed = true`

### 7. M-2 rehearsal (completed)

Gate M2-09 evidence: `release/evidence/keep_path_rc/2026-04-09/m2_rehearsal_report.json`  
