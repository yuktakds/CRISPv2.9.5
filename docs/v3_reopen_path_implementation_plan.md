...
**次にやるべき**: RP-1 widening decision PR acceptance checklist を docs-only で固定する。human decision boundary を先に閉じ、その後にだけ Phase RP-1（widening、human decision + minimal code）へ進む。RP-1 checklist は `v3_rp1_widening_decision_pr_acceptance_checklist.md` を参照する。
...
**decision checklist**: `v3_rp1_widening_decision_pr_acceptance_checklist.md`
