...
- VN-06 is closed for `verdict_record.json` schema freeze, M-1 dual-write authority checks, and M-1 soak proof.
- VN-06 is not an M-2 authority transfer decision.
